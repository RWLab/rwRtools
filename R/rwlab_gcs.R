...
get_pod_meta <- function(pod = NA) {
  ...
  pod_meta <- list(
    ...
    Crypto = list (
      ...
      datasets = c("coinmetrics.csv","ftx_spot_ohlc_1h.feather","ftx_clean_spot_ohlc_1h.feather","ftx_perpetual_funding_rates.feather","ftx_index_ohlc_1h.feather","ftx_futures_ohlc_1h.feather","ftx_coin_lending_rates.feather"),
