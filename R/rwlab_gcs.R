...
get_pod_meta <- function(pod = NA) {
  ...
  pod_meta <- list(
    EquityFactors = list(
      ...
      datasets = c("R1000_ohlc_1d.feather", "R1000_metadata.feather", "R1000_fundamentals_1d.feather", "R1000_fundamentals_snapshot.feather", "streaks_factor_dataset.feather", "extended_streak_factors.feather", "statarb/spreads.feather", "statarb/prices.feather", "statarb/acquisitions.feather"),
